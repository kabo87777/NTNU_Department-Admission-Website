  ...
  <DataTable :value="tableData">
    ...
    <Column field="roles">
      ...
      <template #body="slotProps">
        <Tag v-for="role in truncateRoles(slotProps.data.roles)">{{ role }}</Tag>
      </template>
    </Column>
    ...
    <Column>
      ...
      <template #body="slotProps">
        <Button icon="pi pi-pencil" class="p-button-outlined p-button-success" @click="openModal(slotProps.data)"></Button>
      </template>
    </Column>
  </DataTable>
    ...
    <template #default>
      <div class="w-xl">
        ...
        <div>
          ...
          <InputText type="email" class="w-full" v-model="modalData.email"></InputText>
        </div>

        <div class="mt-5">
          <h3 class="font-black">{{ $t("管理身份組") }}</h3>
          <Divider class="!mt-0"></Divider>
          <div class="inline-flex items-center" v-for="role in modalData.roles">
